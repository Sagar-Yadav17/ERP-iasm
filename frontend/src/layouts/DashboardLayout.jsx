    ...
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      <aside className={`${sidebarOpen ? 'w-64' : 'w-20'} bg-white border-r border-gray-200 flex flex-col transition-all duration-300`}>
        ...
        <div className="h-16 flex items-center px-4 border-b border-gray-200">
          ...
          {sidebarOpen && <span className="ml-3 font-bold text-gray-800 text-lg">Zubron Systems</span>}
        </div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6">
          ...
          <div className="flex items-center gap-4">
            <span className="text-sm text-gray-500">Welcome, <span className="font-semibold text-gray-800">{user?.name}</span></span>
